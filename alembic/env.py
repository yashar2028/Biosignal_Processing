...
# Manually added necessities like creat_engine, load_dotenv
...
# Added Database URL from .env (only the run_migrations_online() is edited). In the url as well we removed +asyncpg so only postgresql
